...
public class DoubleLinkedList<X> implements LinkedListBehavior<X> {
    ...
    private DoubleLinkedNode<X> current;
    private DoubleLinkedNode<X> tail;
    private int size;

    public DoubleLinkedNode<X> getCurrent() {
        return current;
    }

    public void setCurrent(DoubleLinkedNode<X> current) {
...
//    public X retornRoom(int id, ConsultingRoom room){
//        this.head = this.head.getNext();
//        DoubleLinkedNode<ConsultingRoom> tempNode =this.head.getNext();
//        X room = null;
//        while (tempNode != null) {            
//            if (this.current.getElement().getClass()) {
//                
//            }
//        }
//      
